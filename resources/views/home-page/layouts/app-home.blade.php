...
<html lang="en">
    ...
    <body>
        ...
        <!-- Footer-->
        <footer class="py-5 bg-dark" style="background-color: #009933 !important;">
            <div class="container"><p class="m-0 text-center" style="color: #fff">Copyright &copy; Empon Empon 2025</p></div>
        </footer>
        <!-- Bootstrap core JS-->
