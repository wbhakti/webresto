...
<script>
    document.getElementById('checkout-button').addEventListener('click', function(event) {
        ...
        const qris = "00020101021126650013ID.CO.BCA.WWW011893600014000434504202150008850043450420303UKE51440014ID.CO.QRIS.WWW0215ID10264726919750303UKE5204581253033605802ID5914STAR UP COFFEE6006SRAGEN61055721162070703A016304EEEE";
