...
<script>
    document.getElementById('checkout-button').addEventListener('click', function(event) {
        ...
        const qris = "00020101021126650013ID.CO.BCA.WWW011893600014000264666002150008850026466600303UKE51440014ID.CO.QRIS.WWW0215ID10243571248240303UKE5204581253033605802ID5913KOPIAN KLATEN6006KLATEN61055741462070703A016304F394";
